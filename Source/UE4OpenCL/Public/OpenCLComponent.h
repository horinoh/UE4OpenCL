...
public:	
	...
	virtual cl_int EnqueueNDRangeKernel(const cl_command_queue CommandQueue, const cl_kernel Kernel, const cl_uint WorkDim, const size_t* GlobalWork, const size_t* LocalWork = nullptr, const size_t* GlobalWorkOffset = nullptr);
